...
public class AtRuleNoUnknown implements CssRule {
  ...
  private static final String DEFAULT_IGNORED_AT_RULES = "value,at-root,content,debug,each,else,error,for,function,if,include,mixin,return,warn,while,extend,use,foward,/^@.*/";
